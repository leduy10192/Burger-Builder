...
export const auth = (email, password, isSignup) => {
    return {
        ...
        //in our authUserSaga func, we extract email, password, isSignup from the action, so we need to pass that info on
        // when we create the action
        email: email,
        password: password,
        isSignup: isSignup
    }
...
export const authCheckState = () => {
    return{
        type: actionTypes.AUTH_CHECK_STATE //trigger authCheckState Saga
    }
    // return dispatch => {
